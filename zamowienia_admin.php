...
$sql = "SELECT z.id,z.id_produktu, z.ilosc, p.name FROM zamowienie z, products p WHERE id_uzytkownika=$user_id AND z.id_produktu=p.id";
...
<td>
  <form action="delete_order.php" method="post">
    <input type="hidden" id="order_id" name="order_id" value="<?php echo $row['id']; ?>"</input>
